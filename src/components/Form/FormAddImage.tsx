...
export function FormAddImage({ closeModal }: FormAddImageProps): JSX.Element {
  ...
  const formValidations = {
    image: {
      ...
      validate: {
        ...
        acceptedFormats: fileList => fileTypes.some(file => file === fileList[0].type) || 'Somente são aceitos arquivos PNG, JPEG e GIF'
      }
    },
    title: {
  ...
  const mutation = useMutation( async (data: NewImageData) => {
